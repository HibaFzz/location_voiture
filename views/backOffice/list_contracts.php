            ...
            <div class="col-md-3 mb-4">
                <div class="card p-3 shadow-sm">
                    <form method="GET" action="">
                        ...
                        <button type="submit" class="btn btn-primary btn-block" style="background-color: #007BFF; color: white; border: none; padding: 10px 20px; border-radius: 5px; cursor: pointer; transition: background-color 0.3s ease;">Filter</button>
                            ...
                            <div class="card shadow-sm position-relative">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <?php if ($contract['status'] === 'active'): ?>
                                        <span style="background-color: #28a745; color: white; padding: 5px 10px; border-radius: 5px;">Active</span>
                                    <?php elseif ($contract['status'] === 'completed'): ?>
                                        <span style="background-color: #007bff; color: white; padding: 5px 10px; border-radius: 5px;">Completed</span>
                                    <?php elseif ($contract['status'] === 'canceled'): ?>
                                        <span style="background-color: #dc3545; color: white; padding: 5px 10px; border-radius: 5px;">Canceled</span>
                                    <?php else: ?>
                                        <span style="background-color: #6c757d; color: white; padding: 5px 10px; border-radius: 5px;">Unknown</span>
                                    <?php endif; ?>
                                    ...
                                    <div class="btn-group mt-2">
                                        <a href="view_contract.php?id=<?= $contract['id']; ?>" class="btn btn-info btn-sm">View</a>
                                    </div>
                                </div>
                            </div>
                        </div>
